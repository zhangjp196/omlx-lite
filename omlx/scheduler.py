...
class Scheduler:
    ...
    def step(self) -> SchedulerOutput:
        ...
        try:
            # Alternate open prefill opportunities so neither admissions nor
            # in-flight chunks starve. Must run before _schedule_waiting() so
            # that completing prefills are inserted into BatchGenerator before
            # the decode step.
            admit_first = False
